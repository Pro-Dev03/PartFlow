...
قواعد التنفيذ اليومية والحوكمة والاختبارات موثقة بشكل إلزامي في [ENGINEERING-RULES.md](ENGINEERING-RULES.md). هذا الملف يحتفظ بالمبادئ المعمارية طويلة المدى، بينما يحدد المستند الجديد مصدر الحقيقة، ملكية الـ Entities، عقود DB/API، أثر التغيير، وبوابة التحقق.
