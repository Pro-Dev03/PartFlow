...
type MonthlyReturnsAnalysis struct {
	...
	FullReturns              int       `json:"full_returns"`
	PartialReturns           int       `json:"partial_returns"`
	QuantityPartialReturns   int       `json:"quantity_partial_returns"`
	DefectiveReturns         int       `json:"defective_returns"`
	WarrantyReturns          int       `json:"warranty_returns"`
	WarrantyClaims           int       `json:"warranty_claims"`
	SellableItems            int       `json:"sellable_items"`
