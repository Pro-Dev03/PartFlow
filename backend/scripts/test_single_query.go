...
func main() {
	...
	fmt.Println("Testing Dashboard Queries One by One...")
	...
	if err != nil {
		...
		fmt.Printf("   ✅ SUCCESS: Total Sales = %.2f (took %v)\n", totalSales, time.Since(start))
	}
	fmt.Println()
	...
	if err != nil {
		...
		fmt.Printf("   ✅ SUCCESS: Total Purchases = %.2f (took %v)\n", totalPurchases, time.Since(start))
	}
	fmt.Println()
	...
	if err != nil {
		...
		fmt.Printf("   ✅ SUCCESS: Total Expenses = %.2f (took %v)\n", totalExpenses, time.Since(start))
	}
	fmt.Println()
	...
	if err != nil {
		...
		fmt.Printf("   ✅ SUCCESS: Total Products = %d (took %v)\n", totalProducts, time.Since(start))
	}
	fmt.Println()
	...
	if err != nil {
		...
		fmt.Printf("   ✅ SUCCESS: Total Customers = %d (took %v)\n", totalCustomers, time.Since(start))
	}
	fmt.Println()
	...
	if err != nil {
		...
		fmt.Printf("   ✅ SUCCESS: Total Suppliers = %d (took %v)\n", totalSuppliers, time.Since(start))
	}
	fmt.Println()
	...
	if err != nil {
		...
		fmt.Printf("   ✅ SUCCESS: Pending Orders = %d (took %v)\n", pendingOrders, time.Since(start))
	}
	fmt.Println()
	...
	if err != nil {
		...
		fmt.Printf("   ✅ SUCCESS: Low Stock Items = %d (took %v)\n", lowStockItems, time.Since(start))
	}
	fmt.Println()
	...
	if err != nil {
		...
		fmt.Printf("   ✅ SUCCESS: Overdue Debts = %.2f (took %v)\n", overdueDebts, time.Since(start))
	}
	fmt.Println()
	...
	if err != nil {
		...
		fmt.Printf("   ✅ SUCCESS: Pending Returns = %d (took %v)\n", pendingReturns, time.Since(start))
	}
	fmt.Println()
	...
	if err != nil {
		...
		fmt.Printf("   ✅ SUCCESS: Pending Claims = %d (took %v)\n", pendingClaims, time.Since(start))
	}
	fmt.Println()
