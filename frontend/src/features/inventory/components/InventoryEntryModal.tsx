import { ArrowLeft, PackagePlus, Plus, ShoppingCart, Warehouse } from 'lucide-react';
...
export function InventoryEntryModal({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="إضافة مخزون" size="lg">
      <div className="space-y-5">
        <div className="rounded-xl border border-[var(--color-primary-15)] bg-[var(--color-primary-08)] px-5 py-4">
          ...
          <p className="mt-1.5 text-sm leading-6 text-text-secondary">
            اختر المسار المناسب، وسنفتح لك النموذج المطلوب مباشرة.
          </p>
        </div>
        ...
        <button
          ...
          className="pf-entry-option group"
        >
          ...
          <span className="min-w-0 flex-1">
            <span className="mb-1.5 flex flex-wrap items-center gap-2 text-base">
              ...
              <span className="font-semibold text-text-primary">شراء بضاعة من مورد</span>
            </span>
        ...
        >
          ...
          <span className="min-w-0 flex-1">
            <span className="mb-1.5 flex flex-wrap items-center gap-2 text-base">
              <span className="rounded-md bg-[var(--color-primary-10)] px-1.5 py-0.5 text-[10px] font-bold text-[var(--primary)]">03</span>
