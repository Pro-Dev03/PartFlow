...
export function CustomerDetail({
  ...
  const isOverdue = customer.outstandingBalance > 0 // TODO: Add actual overdue logic
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                {customer.email && <InfoRow label="البريد الإلكتروني" value={customer.email} />}
                {customer.address && <InfoRow label="العنوان" value={customer.address} />}
                {customer.city && <InfoRow label="المدينة" value={customer.city} />}
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <InfoRow label="تاريخ التسجيل" value={customer.createdAt} />
                <InfoRow label="آخر شراء" value={customer.lastPurchaseDate || 'لا يوجد'} />
                <InfoRow
                  label="الحالة"
            ...
            {customer.notes && (
              <div className="space-y-4 md:col-span-2">
                ...
                <p className="text-muted bg-muted-10 p-4 rounded-lg">{customer.notes}</p>
              </div>
            )}
          </div>
        )}
