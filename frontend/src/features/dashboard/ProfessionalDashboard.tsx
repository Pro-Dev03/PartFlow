...
import { BarChart3, Activity, Plus, Scan } from 'lucide-react'
  ...
  return (
    <div className="grid grid-cols-[1fr_84px] min-h-screen" style={{ direction: 'rtl' }}>
      ...
      <div className="fixed bottom-6 left-6 flex flex-col gap-2.5 items-start z-50">
        <button className="flex items-center gap-2.5 bg-surface-elevated border border-border text-text px-4.5 py-3 rounded-full text-[13px] font-semibold cursor-pointer shadow-[0_6px_20px_rgba(0,0,0,0.4)] transition-all duration-150 hover:-translate-y-0.5">
          <Scan className="w-[17px] h-[17px]" />
          مسح باركود
        </button>
        <button className="flex items-center gap-2.5 bg-accent text-[#04140F] border border-accent px-4.5 py-3 rounded-full text-[13px] font-semibold cursor-pointer shadow-[0_6px_20px_rgba(0,0,0,0.4)] transition-all duration-150 hover:-translate-y-0.5">
