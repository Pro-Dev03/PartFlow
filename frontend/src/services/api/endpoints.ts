...
export const debtsApi = {
  ...
  adjust: (customerId: string, data: { amount: number; type: 'debit' | 'credit'; reason?: string; product_id?: string; product_quantity?: number; due_date?: string }) => apiClient.post(`/customers/${customerId}/debt-adjustments`, data),
