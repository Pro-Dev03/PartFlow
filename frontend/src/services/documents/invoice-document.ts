...
export function renderInvoiceHtml(document: InvoiceDocument): string {
  ...
  const dateText = Number.isNaN(date.valueOf()) ? '-' : date.toLocaleDateString('ar-SA');
